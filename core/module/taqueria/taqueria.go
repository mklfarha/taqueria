...
type Module interface {
	FetchTaqueriaByID(ctx context.Context, req types.FetchTaqueriaByIDRequest, opts ...Option) (types.FetchTaqueriaByIDResponse, error)
	FetchTaqueriaByName(ctx context.Context, req types.FetchTaqueriaByNameRequest, opts ...Option) (types.FetchTaqueriaByNameResponse, error)
