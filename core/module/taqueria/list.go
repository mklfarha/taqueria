...
func (m *module) List(ctx context.Context,
	...
	list := func() (any, error) {
		...
		defer rows.Close()
		var scanGetters []func(*repogen.Taqueria) any
		...
		var items []repogen.Taqueria
		for rows.Next() {
			var i repogen.Taqueria
		...
		return types.ListResponse{
			Taqueria:    mapModelsToEntities(items),
...
var listFieldRegistry = map[string]func(*repogen.Taqueria) any{
	...
	"id": func(i *repogen.Taqueria) any { return &i.ID },

	"name": func(i *repogen.Taqueria) any { return &i.Name },

	"colonia": func(i *repogen.Taqueria) any { return &i.Colonia },

	"especialidad": func(i *repogen.Taqueria) any { return &i.Especialidad },
