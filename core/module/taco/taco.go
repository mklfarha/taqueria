...
type Module interface {
	FetchTacoByID(ctx context.Context, req types.FetchTacoByIDRequest, opts ...Option) (types.FetchTacoByIDResponse, error)
	FetchTacoByTaqueriaUUIDAndTipo(ctx context.Context, req types.FetchTacoByTaqueriaUUIDAndTipoRequest, opts ...Option) (types.FetchTacoByTaqueriaUUIDAndTipoResponse, error)
